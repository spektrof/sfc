/*
	Some task scheduler, I only used it for k-d tree building
	We need to improve and refactor to make it more flexible
...
private:
	...
	const size_t maximumThread = (size_t) MAXIMUMTHREAD;
